# Generated by Powerlevel10k configuration wizard on 2023-06-21 at 10:51 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    imo                     # imo region
    conan                   # custom CONAN_HOME
    vcsh                    # vcsh repo name 
  )
  [[ -z $SSH_CONNECTION ]] || POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS+=(vpn_ip)
  ...
  function prompt_conan() {
    p10k segment -b 1 -f 3 -t "${CONAN_HOME:t:gs/%/%%}"
  }
  function instant_prompt_conan() {
    prompt_conan
  }

  function prompt_imo() {
    p10k segment -b 1 -f 3 -t "$IMO_REGION_TEXT"
  }
  function instant_prompt_imo() {
    prompt_imo
  }
  function prompt_vcsh() {
    p10k segment -b 1 -f 3 -t "$VCSH_REPO_NAME"
  }
